...
WVPIDController::WVPIDController(double Kp, double Ki, double Kd, double setPoint, bool integralThreshold) :
lastPWM(0), error(0) {
	this -> Kp = Kp;
	this-> Ki = Ki;
	this-> Kd = Kd;
	...
	double WVPIDController::Tick(double encoderDistance) {
